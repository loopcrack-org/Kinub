...
FilePond.create(document.querySelector("input[name='aboutUsVideo']"), {
  labelIdle:
    'Arrastra y suelta tu video o <span class="filepond--label-action"> Selecciona </span>',
  acceptedFileTypes: 'video/mp4',
});

FilePond.create(document.querySelector("input[name='aboutUsImage']"), {
  labelIdle:
