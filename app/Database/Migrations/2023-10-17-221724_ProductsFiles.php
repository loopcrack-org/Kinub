...
class ProductsFiles extends Migration
{
    public function up()
    {
        ...
        $this->forge->addForeignKey('pfProductId', 'products', 'productId', 'NO ACTION', 'NO ACTION', 'pf_product_FK');
        $this->forge->addForeignKey('pfFileId', 'files', 'fileId', 'NO ACTION', 'NO ACTION', 'pf_file_FK');
