<footer class="footer">
    <div class="footer__grid">
        ...
        <div class="network">
            <!--The social networks will be gathered from the database-->
            ...
            <a class="network__link" href="https://twitter.com" target="_blank><span class="network__accessible">Twitter</span></a>
