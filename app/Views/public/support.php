...
<link rel="stylesheet" href="assets/public/css/intl-tel-input.min.css" type="text/css">
        ...
        <form class="support-form" id="support-form" action="/email/soporte" method="POST" novalidate>
            <fieldset class="support-form__fieldset support-form__fieldset--active support-form__step" data-step="1">
                ...
                <div class="support-form__field">
                    ...
                    <input id="support-email" name="support-email" type="email" class="support-form__input required email" data-errors-id="errors-3" placeholder="Ingrese su correo" value="<?php echo old("support-email") ?>">
                </div>
            ...
            <fieldset class="support-form__fieldset support-form__step" data-step="2">
                ...
                <div class="support-form__field">
                    ...
                    <input id="support-model" name="support-model" type="text" class="support-form__input required" data-errors-id="errors-4" placeholder="Ingrese el modelo del producto" value="<?php echo old("support-model") ?>">
                </div>
                ...
                <div class="support-form__field">
                    ...
                    <input id="support-serial" name="support-serial" type="text" class="support-form__input required" data-errors-id="errors-5" placeholder="Ingrese el numero de serie" value="<?php echo old("support-serial") ?>">
                </div>
