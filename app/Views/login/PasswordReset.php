...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Restablecer Contraseña')); ?>
                                    ...
                                    <form method="POST">
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input required type="password" class="form-control pe-5 password-input <?= isset($errors["password"]) ? 'is-invalid' : '' ?>" style="background-image:none" onpaste="return false" placeholder="Ingresa tu nueva contraseña" id="password-input" aria-describedby="passwordInput" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input required type="password" class="form-control pe-5 password-input <?= isset($errors["confirm-password"]) ? 'is-invalid' : '' ?>" style="background-image:none" onpaste="return false" placeholder="Confirma tu contraseña" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="confirm-password-input">
                                                <?php if (isset($errors["password"])) : ?>
                                                    <div class="invalid-feedback">
