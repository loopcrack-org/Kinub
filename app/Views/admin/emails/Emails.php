                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column justify-content-between">
                                                <a href="/admin/emails/ver/<?= $email['emailId']; ?>" class="btn btn-warning btn-icon waves-effect waves-light w-100 mb-2"><i class="mdi mdi-email-search-outline ri-lg" title="Ver Correo"></i></a>
                                                <a href="#" class="btn btn-danger btn-icon waves-effect waves-light w-100" data-bs-toggle="modal" data-bs-target="#deleteEmailsModal" data-id=<?= $email['emailId']?> title="Eliminar Correo"><i class="ri-delete-bin-5-line ri-lg"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php }?>
