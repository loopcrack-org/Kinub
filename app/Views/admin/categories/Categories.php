                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                <a href="/admin/categorias/editar/<?= $category["id"] ?>" class="btn btn-primary btn-icon waves-effect waves-light" style="width: 48%;"><i class="ri-edit-2-fill ri-lg"></i></a>
                                ...
                                <div class="mt-2 text-center">
                                    ...
                                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                        ...
                                        <p class="text-muted mx-4 mb-0">
                                            Eliminar la categoría resultará en la eliminación permanente de las etiquetas y productos relacionados. Esta acción no se puede deshacer.</p>
                                    </div>
                                </div>
